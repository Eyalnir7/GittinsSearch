...
DecisionRule grasp {
  ...
  { (grasped X Y) (held Y) (busy X) komo(touch X Y) (stable X Y) (stableOn ANY Y)!  (initial Y)! }
}
...
DecisionRule place {
  ...
  { (placed Y Z) (on Y Z) (grasped X Y)! komo(touch X Y) (busy X)! (busy Y)! (notheld Y) (INFEASIBLE grasp ANY Y)! block(INFEASIBLE grasp ANY Y) komo(above Y Z) (stableOn Z Y) (stable ANY Y)! }
}
