...
stick1 (table){ joint:rigid shape:capsule, Q:<t(.2 -.9 .07) d(90 1 0 0) >, size:[.5 .02], color:[.6 .6 .6], contact , logical={pusher,object} }
...
Include:'../rai-robotModels/scenarios/ringBox.g'
