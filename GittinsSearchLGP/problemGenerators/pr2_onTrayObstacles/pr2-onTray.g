world: {  }
table1: { pose: [0, 1.4, 0.6, 0.707107, 0, 0, 0.707107], shape: ssBox, size: [0.8, 2.2, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1, fixed: True, logical: {  } }
table2: { pose: [2, 0, 0.6], shape: ssBox, size: [1.2, 2.2, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1, fixed: True, logical: { } }
table3: { pose: [0, -1.4, 0.6, 0.707107, 0, 0, 0.707107], shape: ssBox, size: [0.8, 2.2, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1, fixed: True, logical: {  } }
table4: { pose: [-1.7, 0, 0.6, 0.707107, 0, 0, 0.707107], shape: ssBox, size: [2.2, 0.8, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1, fixed: True, logical: {  } }



worldTranslationRotation(world): { pose: [0.707107, 0, 0, 0.707107], joint: transXYPhi, limits: [-10, -10, -6, 10, 10, 6], shape: marker, size: [10, 10, 0, 0], color: [0, 1, 0], gains: [1, 1], base: True }
floor(world): {shape: ssBox, size: [10, 10, .1, .04], color: [.5 .1], contact: 1, fixed: True, logical: {is_floor, is_place} }
obj0(table1): { pose: [0, 0, 0.15, 0.940649, 0, 0, -0.339381], joint: rigid, shape: ssBox, size: [0.1, 0.1, 0.2, 0.02], color: [1, 0, 0], contact: 1, logical: { is_object } }
#obj1(table1): { pose: [0, 0, 0.15, 0.940649, 0, 0, -0.339381], joint: rigid, shape: ssBox, size: [0.1, 0.1, 0.2, 0.02], color: [1, 0, 0], contact: 1, logical: { is_object } }
#obstacle0(floor): { pose: [1.3, 0, 0.55], joint: rigid, shape: ssBox, size: [0.1, 1, 1, 0.02], color: [1, 0, 0], contact: 1, logical: { is_object, is_obstacle }}
#obstacle1(floor): { pose: [0, 0.8, 0.55], joint: rigid, shape: ssBox, size: [1, 0.1, 1, 0.02], color: [1, 0, 0], contact: 1, logical: { is_object, is_obstacle }}
tray(table2): { pose: [0.2, 0, 0.07], shape: ssBox, size: [0.15, 0.15, 0.04, 0.02], color: [0, 1, 0], logical: { is_place } }
...
_83(table2): { pose: [0.2, 0, 0.07], shape: ssBox, size: [0.27, 0.27, 0.04, 0.02], color: [0, 1, 0] }
...
pr2R(r_wrist_roll_joint): { pose: [0.18, 0, -3.9968e-17, 0.5, 0.5, -0.5, -0.5], shape: ssBox, size: [0.03, 0.03, 0.05, 0.01], color: [1, 1, 0] }
