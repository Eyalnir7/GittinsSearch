...
#OPTIM = debug      ## compile everything with non-optimized debug info (default: optimized debug -g -O3)
#OPTIM = fast	    ## compile without debug info
#OPTIM = fast_debug ## compile with -O3 and debug
